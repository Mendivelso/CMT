...
<body data-spy="scroll" data-target=".navbar" data-offset="60">
      ...
      <div class="row pdd">
        <div class="col-sm-6 col-md-6">
          ...
          <div class="row text-center">
            <img src="../front/img/servicios/icon-ultrasonido.png" class="icon" alt="vascular">
          </div>
          <div class="row text-center">
            <h1 class="h1">
        ...
        <div class="col-sm-6 col-md-6 del">
          <img src="../front/img/servicios/ultrasonido.png" class="servicio-img" alt="logo azul">
        </div>
      </div>
    </div>
    ...
    <div class="container pddTop">
      <div class="row">
        <div class="col-sm-6 col-md-6">
          <img src="../front/img/certificados/ultrasonido.png" class="ser" alt="ser">
        </div>
        <div class="col-sm-6 col-md-6">
      ...
      <div class="row">
        <div class="col-sm-3  col-md-3"><br><br>
          <ul class="procedimientos" type="square">
              ...
              <li> Ecografias</li>
             <li> Doppler (DÚPLEX SCANNING) arterial y venoso</li>
